  ...
  return (
    <div className="space-y-6">
      <section className="flex flex-col gap-4 rounded-xl border border-[#DDE7EF] bg-white p-5 shadow-sm sm:flex-row sm:items-center">
        ...
        <div className="min-w-0 flex-1"><p className="text-[10px] font-bold uppercase tracking-widest text-[#0B8ED0]">Super Admin</p><h2 className="mt-1 text-2xl font-black text-[#0F172A]">Financial Approval Center</h2><p className="mt-1 text-sm font-medium text-slate-500">Final review for financial reports, budget allocations, recorded collections, and cash advances.</p></div>
      ...
      {loading ? <div className="grid gap-4 xl:grid-cols-2">{[1, 2, 3, 4].map((item) => <div key={item} className="h-64 animate-pulse rounded-xl border border-[#DDE7EF] bg-white" />)}</div> : (
