...
- **Create Budget Allocation:** the budget form captures title, amount, warning threshold, and optional linked event.
...
- **View Spending Against Budget:** budget lists include transaction counts and transaction sum fields.
