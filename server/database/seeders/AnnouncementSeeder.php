...
class AnnouncementSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $announcements = [
            ...
            [
                'title' => 'Advisory Notice - Sports Fest Budget Approved',
                'body' => 'The Sports Fest 2024 budget has been reviewed and approved. Department heads may proceed with venue booking and vendor coordination.',
                'created_by' => $officer1->id,
                'target_role' => 'DEPARTMENT_HEAD',
                'category' => 'training',
                'is_published' => true,
