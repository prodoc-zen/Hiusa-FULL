...
class RoleAccessMatrixTest extends TestCase
{
    ...
    public function test_api_role_boundaries_match_the_system_use_case_matrix(): void
    {
        ...
        $users = collect(['SUPER_ADMIN', 'ADMIN', 'SBO_OFFICER', 'DEPARTMENT_HEAD', 'STUDENT'])
        ...
        $cases = [
            ...
            ['POST', '/api/announcements', ['SUPER_ADMIN', 'ADMIN', 'SBO_OFFICER']],
            ['POST', '/api/announcements/generate-draft', ['SUPER_ADMIN', 'ADMIN', 'SBO_OFFICER']],
            ...
            ['GET', '/api/elections/999/results', ['SUPER_ADMIN', 'ADMIN', 'SBO_OFFICER', 'DEPARTMENT_HEAD', 'STUDENT']],
            ['POST', '/api/events', ['ADMIN']],
            ['GET', '/api/events', ['SUPER_ADMIN', 'ADMIN', 'SBO_OFFICER', 'DEPARTMENT_HEAD', 'STUDENT']],
            ['GET', '/api/events/999/attendance', ['SUPER_ADMIN', 'ADMIN', 'SBO_OFFICER', 'DEPARTMENT_HEAD', 'STUDENT']],
            ...
            ['GET', '/api/transactions/personal-receipts', ['SUPER_ADMIN', 'ADMIN', 'SBO_OFFICER', 'DEPARTMENT_HEAD', 'STUDENT']],
            ...
            ['POST', '/api/orders/999/payment', ['ADMIN', 'SBO_OFFICER', 'DEPARTMENT_HEAD', 'STUDENT']],
            ['POST', '/api/tasks', ['ADMIN']],
            ['PATCH', '/api/tasks/999/status', ['ADMIN', 'SBO_OFFICER']],
            ['GET', '/api/approval-requests', ['SUPER_ADMIN', 'ADMIN', 'DEPARTMENT_HEAD']],
        ];
