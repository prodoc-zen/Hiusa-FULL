...
class RoleAccessMatrixTest extends TestCase
{
    ...
    public function test_api_role_boundaries_match_the_system_use_case_matrix(): void
    {
        ...
        $cases = [
            ...
            ['POST', '/api/users/'.$users['STUDENT']->school_id.'/fingerprint', ['ADMIN', 'SBO_OFFICER']],
            ...
            ['POST', '/api/events/999/attendance', ['ADMIN', 'SBO_OFFICER']],
            ...
            ['POST', '/api/budgets/999/advice', ['ADMIN']],
            ['POST', '/api/financial-reports/generate', ['ADMIN']],
            ['POST', '/api/forecasts/generate', ['ADMIN']],
            ['GET', '/api/forecasts', ['ADMIN']],
            ['GET', '/api/financial-reports', ['SUPER_ADMIN', 'ADMIN']],
            ...
            ['PATCH', '/api/orders/999/cancel', ['ADMIN', 'SBO_OFFICER', 'DEPARTMENT_HEAD', 'STUDENT']],
